        ...
        <div className="doorsField__leftColumn">
          <div className="doorsField__leftColumn__segment1">
            ...
            <p className="doorsField__leftColumn__segment1__text">
              ...
              l'ouvrir, celle-ci prend la priorité sur tout le reste, le joueur
          ...
          <div className="doorsField__leftColumn__segment1">
            ...
            <p className="doorsField__leftColumn__segment1__text">
              ...
              priorité reste à l'ouverture de l'une d'elle. Le joueur DOIT alors
              en priorité ouvrir une des portes ouvrables en 12, s'il n'en
              existe pas ou que le mouvement ne peut pas être complété, le
              joueur ouvre alors une porte en 6 pouvant être ouverte sur ce
              nombre de cases.
            </p>
          </div>
          <div className="doorsField__leftColumn__segment1">
        ...
        <div className="doorsField__rightColumn">
          ...
          <div className="doorsField__rightColumn__segment1">
            ...
            <p className="doorsField__rightColumn__segment1__text">
              ...
              mouvement avec la ficha. Si une autre bab, ou tout autre situation
              empêche le mouvement complet, alors l'ouverture de cette porte
              n'est pas possible.
            </p>
          </div>
          <div className="doorsField__rightColumn__segment1">
          ...
          <div className="doorsField__rightColumn__segment1">
            ...
            />
            <p className="doorsField__rightColumn__segment1__text">
              <strong>La porte de la mort</strong> <i>"bab almawt"</i>: est une
              configuration <strong>archaïque</strong> mais efficace où un
              joueur ferme deux portes dans sa colonne de sortie ( dont une à la
              base) afin de ne pas avoir à ouvrir automatiquement en 6 et de
              controler le passage de l'adversaire.
            </p>
          </div>
        </div>
      </div>
